...
signature STRING = sig
  ...
  val toString : string -> CidreExtras.String.string
  val scan       : (char, 'a) StringCvt.reader
                     -> (string, 'a) StringCvt.reader
  val fromString : CidreExtras.String.string -> string option
  val toCString : string -> CidreExtras.String.string
  val fromCString : CidreExtras.String.string -> string option
end
...
structure WideString = struct (*[ assumesig STRING where type char=WideChar.char ]*) end
