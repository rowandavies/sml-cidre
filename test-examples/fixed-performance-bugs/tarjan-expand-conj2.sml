...
(*[
  ...
  datasort 'a left_s_Lzero_end_s_Ltwo_s = 
            $$ of ('a two_ones_w * 'a word) * 'a left_s_Lzero_end_s_Lzero_s

  and 'a left_s_Lzero_end_s_Lzero_s = 
            $$ of ('a zero_ones_w * 'a word) * 'a empty_s | 
            $$ of ('a zero_ones_w * 'a word) * 'a left_s_Lzero_end_s_Ltwo_s

  sortdef 'a Ltwo_s_Lzero_end_s = 'a left_s_Lzero_end_s_Ltwo_s

  datasort 'a Ltwo_end_s_Ltwo_s = 
            $$ of ('a two_ones_w * 'a word) * 'a empty_s | 
            $$ of ('a two_ones_w * 'a word) * 'a Ltwo_end_s_Lzero_s

  and 'a Ltwo_end_s_Lzero_s = 
            $$ of ('a zero_ones_w * 'a word) * 'a Ltwo_end_s_Ltwo_s

  sortdef 'a Ltwo_s_Ltwo_end_s = 'a Ltwo_end_s_Ltwo_s 

  datasort 'a left_s_Lzero_end_s_Lzero_s = 
            $$ of ('a zero_ones_w * 'a word) * 'a empty_s | 
            $$ of ('a zero_ones_w * 'a word) * 'a left_s_Lzero_end_s_Ltwo_s

  and 'a left_s_Lzero_end_s_Ltwo_s = 
        $$ of ('a two_ones_w * 'a word) * 'a left_s_Lzero_end_s_Lzero_s

  sortdef 'a Lzero_s_Lzero_end_s =  'a left_s_Lzero_end_s_Lzero_s

  datasort 'a Ltwo_end_s_Lzero_s = 
           $$ of ('a zero_ones_w * 'a word) * 'a Ltwo_end_s_Ltwo_s

  and 'a Ltwo_end_s_Ltwo_s = 
            $$ of ('a two_ones_w * 'a word) * 'a empty_s | 
            $$ of ('a two_ones_w * 'a word) * 'a Ltwo_end_s_Lzero_s

  sortdef 'a Lzero_s_Ltwo_end_s = 'a Ltwo_end_s_Lzero_s

        datasort 'a right_s___Rzero_end_s___Rzero_s = 
            $$ of ('a word * 'a zero_ones_w) * 'a empty_s | 
            $$ of ('a word * 'a zero_ones_w) * 'a right_s___Rzero_end_s___Rtwo_s

        and 'a right_s___Rzero_end_s___Rtwo_s = 
        $$ of ('a word * 'a two_ones_w) * 'a right_s___Rzero_end_s___Rzero_s

        datasort 'a short_s___Rone_s = $$ of ('a word * 'a ones_w) * 'a empty_s
        datasort 'a left_s___Rone_s = $$ of ('a switch_w * 'a ones_w) * 'a Rone_s


        datasort 'a switch_p___Rzero_p = 
            $$$ of 'a right_s___Rzero_end_s___Rzero_s * 'a switch_p___Rtwo_p | 
            $$$ of 'a right_s___Rzero_end_s___Rzero_s * 'a switch_p___Rzero_p | 
            $$$ of 'a short_s___Rone_s * 'a switch_p___Rzero_p | 
            $$$ of 'a left_s___Rone_s * 'a switch_p___Rzero_p

        and 'a switch_p___Rtwo_p = 
            @@@
          | $$$ of 'a right_s___Rzero_end_s___Rtwo_s * 'a switch_p___Rtwo_p | 
            $$$ of 'a right_s___Rzero_end_s___Rtwo_s * 'a switch_p___Rzero_p | 
            $$$ of 'a short_s___Rone_s * 'a switch_p___Rtwo_p | 
            $$$ of 'a left_s___Rone_s * 'a switch_p___Rtwo_p



  (* Swapped the order of the following. *)
    datasort      'a Ltwo_p  = @@@
                      | $$$ of ('a Ltwo_s_Lzero_end_s) * 'a Ltwo_p
                      | $$$ of ('a Ltwo_s_Ltwo_end_s)  * 'a Lzero_p
                      | $$$ of  'a Lone_s                    * 'a Ltwo_p
       and 'a Lzero_p = $$$ of ('a Lzero_s_Lzero_end_s) * 'a Ltwo_p
                      | $$$ of ('a Lzero_s_Ltwo_end_s)  * 'a Lzero_p
