...
(* Modifications: Rowan Davies *)
(* Sorts added by: Frank Pfenning and Rowan Davies *)

(* This is a small modification of the red-black tree example to use
   Chris Okasaki's simplified rebalancing.  It sort checks without
   changing the datasort declarations.  - Rowan *)
