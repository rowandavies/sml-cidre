...
(*[
  ...
  *)
  ...
  val myref = (ref (*[ :> ExpFam option -> ExpFam option ref & ExpObj option -> ExpObj option ref ]*))

  (*[ refNONE :> unit -> ExpFam option ref & unit -> ExpObj option ref ]*)
  fun refNONE () = myref NONE
    
  (*[ val newEVar : (ExpFam -> ExpObj) & (ExpKind -> ExpFam)  ]*)
  fun newEVar (V) = EVar(refNONE(), V)
(*  fun newEVar (V) = EVar(ref (NONE (*[:> ExpFam option, ExpObj option ]*)) , V) *)
