...
Revision 1.1  2004/09/17 22:35:51  rowan_sorts
Moved signature files so that they are unique without a case
distinction.  This is needed so the system can be built under MS
Windows.

Revision 1.2  2003/01/08 03:39:45  rowan_sorts
*** empty log message ***
