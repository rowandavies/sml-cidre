...
(* ITERATORS *)
    ...
    fun map f (Set l) = Set (Edlib.List.map f l)

    fun apply f (Set l) = Edlib.List.apply f l


(* REDUCERS *)

    fun fold f base (Set l) = Edlib.List.foldL f base l

    fun fold' f (Set []) = raise Empty "fold'"
    |   fold' f (Set l)  = Edlib.List.foldL' f l
