...
signature FLAGS =
  sig
    ...
    val DEBUG_REFOBJECTS:   bool ref
    val DEBUG_REFDEC:       bool ref
    val DEBUG_SORTS:        bool ref
    val DEBUG_SORTVARS:     bool ref
    val allow_noncovariant_refinements: bool ref

    val PRINT_DATASORT_PROGRESS : bool ref

    val load_prelude : bool ref
   ...
   (*Compiler debug options: *)
    ...
    val timings_stream : TextIO.outstream option ref   (* optional stream for exporting timings (`KITtimings') *)
