...
(*[  datasort 'a badRight              (* invariant possibly violated at the right child *)
  ...
  *)
  ...
  in
    ...
    (*[ val insertPersistant :> 'a rbt ref -> key' * 'a -> 'a rbt ref ]*)
    val insertPersistant = (fn table => fn entry => ref (insert (!table, entry)))

    fun copy table = ref (!table)
    ...
    (*[ val lookup :> 'a rbt ref -> key -> 'a  option  ]*)
